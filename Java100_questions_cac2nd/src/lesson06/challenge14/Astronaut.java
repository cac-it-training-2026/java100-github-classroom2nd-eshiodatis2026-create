...
class Spaceship {
	...
	public boolean compareFuel(double fuelNum, double lightYear) {
		...
		//isCheckに判定結果を入れる
		//falseで初期化する→初期値を明確にするため。ローカル変数は初期化しないと使えない。
		//後から代入する前提。実行クラスで最終的な値が決まるため、最初は意味のある初期値falseを入れておく。
...
public class Astronaut {
	...
	public static void main(String[] args) throws IOException {
		...
		//ここに適切な処理を記述す
		Spaceship spaceship = new Spaceship();//実行クラスAstrounautでSpaceshipのオブジェクト生成
		boolean isCheck = false;//
